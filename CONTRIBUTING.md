# Contributing to Mockery Rector
...
```bash
git clone git@github.com:ghostwriter/mockery-rector.git
cd mockery-rector
git remote add upstream git://github.com/ghostwriter/mockery-rector.git
```
